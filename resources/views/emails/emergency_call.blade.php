<div class="">
    <div class="aHl"></div>
    <div id=":ox" tabindex="-1"></div>
    <div id=":nq" class="ii gt" jslog="20277; u014N:xr6bB; 4:W251bGwsbnVsbCxbXV0.">
        <div id=":nr" class="a3s aiL msg-5738431489066114368">
            <div
                                    ...
                                    <tbody>
                                        <tr>
                                            <td
                                                ...
                                                <a href="http://192.168.20.78:8000/"
                                                    ...
                                                    target="_blank"
                                                    data-saferedirecturl="http://192.168.20.78:8000/">
                                                    Ctrl Documents
                                                </a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="100%" cellpadding="0" cellspacing="0"
                                                ...
                                                <table class="m_-5738431489066114368inner-body" align="center"
                                                        ...
                                                        <tr>
                                                            <td
                                                                ...
                                                                <p
                                                                    ...
                                                                    Estás recibiendo este email porque se ha cargado un nuevo documento.</p>
                                                                                                    ...
                                                                                                    <tbody>
                                                                                                        <tr>
                                                                                                            <td
                                                                                                                style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol'">
                                                                                                                <a href="http://192.168.20.78:8000/"
                                                                                                                    class="m_-5738431489066114368button"
                                                                                                                    rel="noopener"
                                                                ...
                                                                <p
                                                                    style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';font-size:16px;line-height:1.5em;margin-top:0;text-align:left">
                                                                    Este enlace te permite ingresar a software para consultar tus documentos.</p>
                                                                <p
                                                                    style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';font-size:16px;line-height:1.5em;margin-top:0;text-align:left">
                                                                    Si no tienes conocimiento sobre CtrlDocument, te invitamos a vistar nuesto sitio.</p>
                                                                <p
                                                                    style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';font-size:16px;line-height:1.5em;margin-top:0;text-align:left">
                                                                    Saludos,<br>
                                                                    Ctrl Documents</p>
                                                                        ...
                                                                        <tr>
                                                                            <td
                                                                                ...
                                                                                <p
                                                                                    ...
                                                                                    the "Restablecer contraseña" button,
                                                                                    copy and paste the URL below
                                                                                    into your web browser: --}}
                                                                                    Si tiene problemas para hacer clic en el botón "Ctrl Documents", copie y pegue la URL a continuación en su navegador web:
                                                                                    <span
                                        ...
                                        <tr>
                                            <td
                                                style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol'">
                                                <table class="m_-5738431489066114368footer" align="center" width="570"
                                                        ...
                                                        <tr>
                                                            <td align="center"
                                                                ...
                                                                <p
                                                                    ...
                                                                    © 2021 Ctrl Documents. Todos los derechos
                                                                    reservados.</p>
    ...
    <div id=":ot" class="ii gt" style="display:none">
