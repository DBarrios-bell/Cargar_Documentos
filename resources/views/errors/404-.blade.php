...
<br><br>
<div>
    <a href="{{ route('home') }}" style="font-size: 25px; color:white; text-decoration: none;">Clic Aqui para Volver</a>
</div>
<a href="https://codepen.io/ZonFire99/full/njdls/" class="viewFull" target="_parent">View in full it looks way
    better :)</a>
